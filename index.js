...
root.style.setProperty(
  "--gradient",
  "linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(87,90,94,1) 60%, rgba(213,213,219,1) 100%)"
);
...
toggleBtn.addEventListener("click", () => {
  if (toggleBtn.classList.contains("toggled")) {
    ...
    root.style.setProperty(
      "--gradient",
      "linear-gradient(90deg, rgba(213,213,219,1) 0%, rgba(87,90,94,1) 60%, rgba(0,0,0,1) 100%)"
    );
  }
  reset();
});
